...
class Bot(Client):
    ...
    async def start(self):
        ...
        globals()["CUSTOM_FILE_CAPTION"] = await script.get_caption() or environ.get(
            "CUSTOM_FILE_CAPTION", "{script.CAPTION}"
        )
        globals()["BATCH_FILE_CAPTION"] = await script.get_caption() or environ.get(
